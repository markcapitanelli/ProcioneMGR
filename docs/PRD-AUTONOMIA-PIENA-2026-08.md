...
| # | Cosa | esito |
|---|---|---|
| K41 ✅ | **`RecordedAtUtc`**: l'ora di parete accanto all'ora di candela, messa dal database e inforgiabile. Le 371 righe storiche restano `NULL`. *Dal 2026-09-04 ha un lettore: una riga scritta più di tre barre dopo la sua candela è replay e non entra nel ritiro né nel decadimento (`TradeDeduplication.Vivi`, doc 42 §9)* |
...
| K57 ✅ | **Il gate di stabilità**: un'ipotesi «sopravvive alla rimisurazione?» guardando FRA i run. *Applicato all'ordinamento della lista dei grigi letta dall'umano (`GreyDeployer.ListGreyAsync`), NON alla coda automatica della flotta* — [doc 40 §4.3](audit/40_CACCIA_19_E_STABILITA_2026-09-03.md). *Dal 2026-09-04 conta solo le rimisurazioni del motore corrente (`Fleet:StabilitaDaUtc`, default 2026-08-23)* |
