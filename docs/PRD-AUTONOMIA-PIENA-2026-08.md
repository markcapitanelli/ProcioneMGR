...
| **K5c** | **Il controllo «nodo Ready» del bring-up è un falso negativo che costa 5-6 minuti a ogni giro.** Misurato tre volte il 30-31/08: `bringup.ps1` scrive «nodo NON Ready dopo 5 minuti» mentre `kubectl get nodes` risponde `Ready` nello stesso momento | il bring-up prosegue appena il nodo è davvero pronto, e il tempo torna sotto i 2 minuti |
