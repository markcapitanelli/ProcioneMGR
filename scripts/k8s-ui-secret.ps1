...
Write-Host "Secret 'ui-secrets' pronto in $namespace (connection string + master key)." -ForegroundColor Green

# Confronto attivo con trading-secrets: la divergenza fra le due copie e' un errore silenzioso
# (fallisce solo al primo uso delle credenziali), quindi vale la pena scoprirlo adesso invece che
# affidarsi alla disciplina di chi lancia gli script.
